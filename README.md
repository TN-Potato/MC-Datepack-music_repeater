...
2.中に入っているmusic_repeater_ver-1.1.2専用リーソースパック.zipを適用

3.中に入っているmusic_repeater_ver-1.1.2.zipをこのデータパックを使いたいワールドのdatapacksに入れる
...
ver-1.1 音量調節を主音量から声/スピーチで変更できるように変更した。
  ...
  ver-1.1.1 ver-1.1の修正,stopコマンドの追加。
